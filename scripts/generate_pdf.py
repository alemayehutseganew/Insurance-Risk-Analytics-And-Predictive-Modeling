...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, 'Interim Submission - Report', 0, 1, 'C')
        self.ln(5)
...
def generate_report():
    ...
    report_path = os.path.join(os.path.dirname(__file__), '..', 'reports', 'interim_submission.md')
    output_path = os.path.join(os.path.dirname(__file__), '..', 'reports', 'interim_submission.pdf')
